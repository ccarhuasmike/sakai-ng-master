...
export class DetalleBotoneraComponent implements OnInit {
    ...
    constructor(
        private detalleBotoneraService: DetalleBotoneraService,
        private toastr: MessageService,
        public dialogRef: DynamicDialogRef,
        public config: DynamicDialogConfig
        // public dialogRef: MatDialogRef<DetalleBotoneraComponent>,
    ...
    getConfiguracion() {
        ...
        var resp = {
            ...
            "data": {
                "idTarjeta": 47934,
                "disposicionEfectivo": true,
                "comprasInternet": true,
                "comprasInternacionales": true,
                "habilitacionUsoGeneral": true
            }
        };
        if (resp['codigo'] == 0) {
        ...
        //     .subscribe(
        //         (resp: any) => {
        //             console.log('getConfiguracion()...', resp);
    ...
    getHistorial() {
        ...
        var resp:any = { "codigo": 0, "mensaje": "OK", "data": [] };
        if (resp['codigo'] == 0) {
            let data = resp['data'];
